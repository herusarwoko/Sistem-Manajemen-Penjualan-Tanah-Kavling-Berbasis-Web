  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Data Transaksi Pembelian</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
    ...
    <section class="content">
      <div class="card">
        <div class="card-header">
          <h3 class="card-title">Data Pembeliak Kavling</h3>
              <div class="card-tools">
                <a href="<?=base_url('transaksi/tambah');?>" class="btn btn-info btn-sm" ><i class="fa fa-plus"></i> Transaksi Baru</a>&nbsp;
           ...
           <table id="table" class="table table-striped table-hover table-bordered" cellspacing="0" width="100%">
                <thead>
                    <tr>
                        ...
                        <th width="25%">Lokasi Kavling</th>
                        <th width="15%">Jenis Pembelian</th>
                        <th width="15%">AJB</th>
