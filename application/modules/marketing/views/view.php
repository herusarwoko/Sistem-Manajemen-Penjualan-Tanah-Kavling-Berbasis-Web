  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Data Sales / Marketing</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="<?php echo base_url('dashboard'); ?>">Home</a></li>
              <li class="breadcrumb-item active">Data Sales / Marketing</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    ...
    <section class="content">
      <div class="card">
        <div class="card-header">
          <h3 class="card-title">Data Sales / MArketing</h3>
              <div class="card-tools">
                <a href="#" class="btn btn-info btn-sm" onclick="add()"><i class="fa fa-plus"></i> Tambah Sales / Marketing</a>&nbsp;
           ...
           <table id="table" class="table table-striped table-hover table-bordered" cellspacing="0" width="100%">
                <thead>
                    <tr>
                        ...
                        <th width="15%">Penjualan Progres</th>
                        <th width="15%">Penjualan Close</th>
                ...
                <form action="#" id="form" class="form-horizontal">
                    ...
                    <div class="form-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-3">
                                <input name="no_telp" placeholder="" class="form-control" type="no_telp">
                                <span class="help-block"></span>
                            </div>
                        </div>
...
<script type="text/javascript">
  ...
  $(document).ready(function() {
   ...
   function add()
   {
       ...
       $('.modal-title').text('Tambah sales'); // Set Title to Bootstrap modal title
   }
   ...
   function edit(id)
   {
       ...
       $.ajax({
           ...
           {
               $('[name="id"]').val(data.id_marketing);
               $('[name="nama_lengkap"]').val(data.nama_marketing);
               $('[name="alamat"]').val(data.alamat);
               $('[name="jenis_kelamin"]').val(data.jenis_kelamin);
               $('[name="no_telp"]').val(data.no_telp);

               $('#modal_form').modal('show'); // show bootstrap modal when complete loaded
               $('.modal-title').text('Edit Data mArketing'); // Set title to Bootstrap modal title
...
<script type="text/javascript">
  ...
  function detail(id, jenis){
      $('#lampiran').load(url + 'marketing/lampiran/'+id );
...
<div class="modal fade bd-example-modal-xl" id="lampiran_akte" tabindex="-1" role="dialog" aria-labelledby="modalLabel">
