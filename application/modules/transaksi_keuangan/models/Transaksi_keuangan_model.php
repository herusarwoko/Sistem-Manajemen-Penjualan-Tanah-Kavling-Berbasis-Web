...
class Transaksi_keuangan_model extends CI_Model {
	...
	var $order = array('transaksi_tanggal, transaksi_id' => 'DESC'); // default order 
	...
	private function _get_datatables_query()
	{
		...
		$this->db->join('kategori', 'transaksi.transaksi_kategori = kategori.kategori_id', 'left');
		$this->db->join('barang', 'transaksi.transaksi_barang = barang.barang_id', 'left');
	...
	{
		$this->db->delete($this->table, ['transaksi_id'=>$id]);
	}
