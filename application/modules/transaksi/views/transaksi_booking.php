  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Booking Kavling</h1>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    </div>
    ...
    <section class="content">
      <div class="card">
        ...
        <div class="card-body">
          ...
          <form action="<?=base_url('transaksi/booking_proses');?>" id="form" class="form-horizontal" method="POST">
            ...
            <div class="form-body">
              ...
              <div class="form-group row">
                ...
                <div class="col-md-3">
                  ...
                  <input name="tanggal" placeholder="" class="form-control" type="date" id="tanggal">
                ...
                <div class="col-md-3">
                  <!-- Tambahkan id pada input tanggal untuk mempermudah pengambilan nilai dengan JavaScript -->
                  <input name="tgl_expired" placeholder="" class="form-control" type="date" id="tgl_expired">
                  <span class="help-block"></span>
                </div>
              </div>
              ...
              <div class="form-group row">
                ...
                <div class="col-md-3">
                <input name="nominal_booking" id="nominal_booking" class="form-control" type="text" disabled value="100.000">
                        <input name="pem_booking_int" id="pem_booking_int" class="form-control" type="hidden" value="100.000">
                        <span class="help-block"></span>
                </div>
              </div>
              ...
              <div class="form-group row">
                ...
                <div class="col-md-4">
                  <input name="keterangan" id="keterangan" class="form-control" type="text" value="">
                  <span class="help-block"></span>
                </div>
              </div>
